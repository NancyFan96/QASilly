...
public class AnswerExtract
{
    ...
    private final String dir = "/Users/zhouyang/Workspaces/QASystem/src/";
    private final String file_snippet_prefix = dir + "snippet_zhidao_" + file_type + "/snippet_for_";
    private final String file_key_words = dir + "in/key_word_" + file_type;
    private final String file_answer_type = dir + "in/answer_type_" + file_type;
    private final String file_test = dir + "in/test.txt";


    private final String file_question = dir + "in/question_" + file_type + ".txt";
    private final String file_vectors = dir + "in/vectors.bin." + file_type;

    private final String file_predict_sentence = dir + "meta/predict_sentence.txt";
    private final String file_predict_words = dir + "meta/predict_words.txt";

    private final String file_res = dir + "out/results" + file_type + ".txt";
...
//                cnt_ideal++;
                                      ...
                                      String sentence, ArrayList<String> candidate_words, String answertype, int ques_cnt) throws IOException
    {
        ...
        if(answerFromZhidao!=null && !pp.matcher(answerFromZhidao).find())
